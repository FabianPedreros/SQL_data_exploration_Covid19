...
--Looking at the probaibily to die if you contract Covid in your Country
...
-- Looking the likelihood of dying  per country in 2022-03-02 order by deaths percentage
...
-- Looking the percentage of cases by population
...
-- Top five countries with the highest infection ratio by population
...
CREATE VIEW PercentPopulationVaccinated AS
	...
	-- Base view with all the rows and columns need it (Cases, Deaths and Vaccination)
